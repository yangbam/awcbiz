/* ==========================================================================
   IPA site — activity-detail.html rendering.
   Reads ?id=... from the URL and looks the activity up in DataStore.
   ========================================================================== */
...
(function () {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    var item = id ? window.DataStore.getActivities().filter(function (a) { return a.id === id; })[0] : null;
    ...
    document.title = item.title + " | IPA - Infrastructure Project Association";
